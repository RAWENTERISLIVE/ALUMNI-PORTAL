...
import { GraduationCap, Users, MessageSquare, Briefcase, ChevronRight, Star, Trophy, Globe, BookOpen } from "lucide-react";
...
export default function HomePage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <header className="bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 text-white py-20">
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="space-y-8 max-w-2xl">
            <div>
              ...
              <p className="text-xl md:text-2xl opacity-90 mt-6">
                Join thousands of alumni building careers, sharing opportunities, and creating lasting professional relationships.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-6 py-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-semibold">10,000+ Alumni</span>
              </div>
              <div className="flex items-center space-x-2">
                <Briefcase className="h-5 w-5 text-orange-200" />
                <span className="font-semibold">500+ Job Postings</span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Button asChild size="lg" className="bg-white text-orange-600 hover:bg-gray-50 hover:scale-105 transition-all duration-300 shadow-lg px-8">
                <Link to="/register">Start Networking</Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="border-white text-white hover:bg-white/10 transition-all duration-300 px-8">
          ...
          <div className="hidden lg:block relative">
            <div className="absolute -top-6 -left-6 w-32 h-32 bg-orange-200 rounded-full opacity-20 animate-pulse"></div>
            <img 
              src="https://images.unsplash.com/photo-1531482615713-2afd69097998?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80" 
              alt="Professional Network" 
              className="rounded-2xl shadow-2xl w-[500px] h-auto relative z-10"
            />
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-orange-300 rounded-full opacity-20 animate-pulse"></div>
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600">
              Powerful features designed to help you connect, learn, and advance your career.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 transition-all duration-300 hover:scale-105">
              <div className="h-16 w-16 bg-blue-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <Users className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Alumni Directory</h3>
              <p className="text-gray-600">
                Search and connect with alumni by industry, location, graduation year, and skills.
              </p>
            </div>
            
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-green-50 to-green-100 hover:from-green-100 hover:to-green-200 transition-all duration-300 hover:scale-105">
              <div className="h-16 w-16 bg-green-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <Briefcase className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Job Opportunities</h3>
              <p className="text-gray-600">
                Discover exclusive job postings from alumni-owned companies and partner organizations.
              </p>
            </div>
            
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-purple-50 to-purple-100 hover:from-purple-100 hover:to-purple-200 transition-all duration-300 hover:scale-105">
              <div className="h-16 w-16 bg-purple-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <MessageSquare className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Groups & Forums</h3>
              <p className="text-gray-600">
                Join interest-based groups and engage in meaningful discussions with peers.
              </p>
            </div>
            
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-orange-50 to-orange-100 hover:from-orange-100 hover:to-orange-200 transition-all duration-300 hover:scale-105">
              <div className="h-16 w-16 bg-orange-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <GraduationCap className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Mentorship</h3>
              <p className="text-gray-600">
                Find mentors or become one. Share knowledge and accelerate career growth.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              See how our alumni are making an impact in their industries and communities.
            </p>
          </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-orange-500">Class of 2015</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "The alumni network helped me find my co-founder and secure our first round of funding. 
                Now we're a $50M company with 200+ employees."
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Senior Director, Global Corp</p>
                  <p className="text-sm text-orange-500">Class of 2012</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "Through mentorship connections, I advanced from analyst to senior director in just 8 years. 
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Non-Profit Director</p>
                  <p className="text-sm text-orange-500">Class of 2010</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "Alumni connections helped me transition from corporate to non-profit work. 
                I'm now leading initiatives that impact thousands of lives."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4 text-gray-900">Excellence in Education</h2>
            <div className="h-1 w-20 bg-orange-500 mx-auto mb-6"></div>
            <p className="text-gray-600 text-lg">
              A tradition of academic excellence and innovation that spans generations
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col items-center text-center hover:border-orange-300 hover:shadow-md transition-all duration-300">
