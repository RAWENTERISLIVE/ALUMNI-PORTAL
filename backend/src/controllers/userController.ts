...
export const updateProfile = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  // ✅ GOOD: Strict input whitelist mapping to prevent Mass Assignment vulnerability
  // (e.g., preventing standard users from modifying 'role', 'isVerified', 'hasPremiumBadge', etc.)
  const allowedFields = [
