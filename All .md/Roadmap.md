...
## 4. Posts  
1. **Create Post**  
   - Rich editor (text, images, attachments ≤ 50 MB)  
   - Audience: Public ∣ Alumni ∣ Students ∣ Connections ∣ Group  
2. **Detail View**: nested comments, reactions  
...
| 3     | Community Groups & Events    | • Group creation/join<br>• Group feed<br>• Group admin tools<br>• Events widget | Not Started    | —            |                            |
| 4     | Career & Mentorship          | • Job Board MVP<br>• Mentorship directory & requests<br>• Basic chat<br>• Notifications | Not Started    | —            |                            |
| 5     | Admin Console & Analytics    | • Full Admin panel<br>• Audit logs<br>• Site settings<br>• Analytics charts | Partially Done    | —            | Basic admin panel exists |
| 6     | Polish & Advanced Features   | • Real-time chat<br>• Calendar integration<br>• AI suggestions<br>• Mobile PWA | Not Started    | —            |                            |
